...
void newDataCallback(const bme68xData data, const bsecOutputs outputs, Bsec2 bsec) {
  ...
  for (uint8_t i = 0; i < outputs.nOutputs; i++) {
    ...
    switch (output.sensor_id) {
      ...
      case BSEC_OUTPUT_RAW_PRESSURE:
        pressure = output.signal / 100.0; // Konvertiere Pa zu hPa
        break;
  ...
  displaySensorData(temperature, pressure, humidity);
}

void displaySensorData(float temperature, float pressure, float humidity) {
